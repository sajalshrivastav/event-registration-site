...
<div class="container bg-white rounded p-5" >
    ...
    <div class="col-md-12">  
      <table class="table table-bordered table-hover bg-white">
        ...
        <!-- {% for event in pid.pid_event.all%} -->
            ...
            ?>
            <tr>
              <td><?php echo $ress1['reg_event']?>,<?php echo $ress1['tid']?></td>
  ...
  <div class="row d-print-none">
    <div class="col-md-12 mt-2  text-center">
      <form mthod="get"  action="find_pid _registration.php">
        <input class="btn btn-color serach-btn " type="button" value="Print this page" onClick="window.print()">
        <a href="find_pid _registration.php" value="<?=$_GET['pid'];?>" class="btn btn-color serach-btn mx-2">Register for Event</a>
      </form>
    </div>
  </div>
  </div>
