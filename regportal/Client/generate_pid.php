...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "Select * from pid where roll_no= '" . $_SESSION['roll_no']    . "'   ";
    ...
    // if($num !== $roll_no){
    //     $sql = "INSERT INTO `pid` ( `name`,`roll_no`,`phone`,`batch`,`branch`,`course`,`gender`,`email`, `college name`) VALUES ('$name','$roll_no','$phone','$batch','$branch','$courses','gender','email','$college')";
    //     // $sql = "UPDATE pid SET pid = 'PS2K22120001'";
    //     $result = mysqli_query($con, $sql);
    //     if ($result) {
    //             $showAlert = true; 
    //         }
