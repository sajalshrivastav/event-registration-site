...
<div class="container">
  ...
  <div class="container-fluid row">
    <div class="card col">
        ...
        <p style="font-size:20px;font-weight:200;margin-top:10px">Click on below given button to view PID</p>
        <div class="details">
            <div class="column">
            <h1><?php
                    echo $row
...
<div class="card col">
        ...
        <h2>Register Team</h2>
        <p style="font-size:20px;font-weight:200;margin-top:10px">Click on below given button to view TID</p>
        <div class="details">
            <div class="column">
            <h1><?php
                    echo $row2
...
<div class="card">
        ...
        <p style="font-size:20px;font-weight:200;margin-top:10px">Click on below given button to view Events Wise Registration</p>
        <div class="details">
            <div class="column">
              <h1>0</h1>
        ...
        <div class="buttons">
          <!-- <button ><a href="register_event.php">Click Here</a></button> -->
          <button ><a class="summary" style="color:#fff;"href="event_wise_registration.php">Solo List</a></button>
          <button ><a class="summary" href="event_wise_registration_team.php">Team List</a></button>
        </div>
    </div>
