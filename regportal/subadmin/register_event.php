...
<body>
  ...
  <h1 class="bg-warning m-2" style="color:#fff">VIEW AND DELETE DATA OF <?php echo $_SESSION['pid'];?></h1>
  <div class="col-md-12">
    <table class="table table-bordered table-hover bg-white">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <form action="register_event.php" method="POST" class="d-inline">
  ...
  <form>
        ...
        <a href="print_pid_slip.php" class="btn btn-color serach-btn mx-2">Print Slip</a>
      </form>
  <h1 class="bg-warning m-2" style="color:#fff" >ADD Solo EVENTS To <?php echo $_SESSION['pid']; ?></h1>
  <section>
