...
if(isset($_POST['delete_event']))
{
    ...
    if($query_run)
    {
        ...
        header("Location: register_event_team.php");
        exit(0);
    }
    else
    {
...
<body>
  ...
  <h1 class="bg-warning m-2" style="color:#fff">VIEW AND DELETE DATA OF <?php echo $_SESSION['tid'];?></h1>
  <div class="col-md-12">
    <table class="table table-bordered table-hover bg-white">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <form action="register_event_team.php" method="POST" class="d-inline">
  ...
  <form>
        ...
        <a href="print_tid_slip.php" class="btn btn-color serach-btn p-2">Print Slip</a>
      </form>
  <h1 class="bg-warning m-2" style="color:#fff" >ADD Solo EVENTS To <?php echo $_SESSION['tid']; ?></h1>
  <section>
